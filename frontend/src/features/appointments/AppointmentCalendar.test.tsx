...
describe('calendar interaction', () => {
  it('places an appointment at its scheduled time and opens details', () => {
    render(<AppointmentCalendar dates={['2026-09-20']} loading={false} appointments={[{ id: 'a', patientId: 'p', doctorId: 'd', patientName: 'Patient A', doctorName: 'Doctor A', appointmentDate: '2026-09-20T00:00:00Z', appointmentTime: '02:00 PM', status: 'BOOKED' }]} />);
  ...
  it('keeps unconfirmed times visible outside the hourly grid', () => {
    render(<AppointmentCalendar dates={['2026-09-20']} loading={false} appointments={[{ id: 'b', patientName: 'Patient B', appointmentDate: '2026-09-20', appointmentTime: null, status: 'PENDING_CONFIRMATION' }]} />);
